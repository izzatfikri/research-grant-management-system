        ...
        <div class="list-group list-group-flush list-group-hoverable">
            <div class="list-group-item">
                <div class="row align-items-center">
                    ...
                    <div class="col text-truncate">
                        <a href="#" class="text-body d-block">Grant Application 1</a>
                        <div class="d-block text-secondary text-truncate mt-n1">
                            Submitted new grant application for AI research (#12345)
                        </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="list-group-item">
                <div class="row align-items-center">
                    ...
                    <div class="col text-truncate">
                        <a href="#" class="text-body d-block">Grant Application 2</a>
                        <div class="d-block text-secondary text-truncate mt-n1">
                            Approved grant for renewable energy project (#12346)
                        </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="list-group-item">
                <div class="row align-items-center">
                    <div class="col-auto"><span class="status-dot d-block"></span></div>
                    <div class="col text-truncate">
                        <a href="#" class="text-body d-block">Grant Application 3</a>
                        <div class="d-block text-secondary text-truncate mt-n1">
                            Updated budget for healthcare grant (#12347)
                        </div>
                    </div>
                    <div class="col-auto">
                        <a href="#" class="list-group-item-actions">
            ...
            <div class="list-group-item">
                <div class="row align-items-center">
                    ...
                    <div class="col text-truncate">
                        <a href="#" class="text-body d-block">Grant Application 4</a>
                        <div class="d-block text-secondary text-truncate mt-n1">
                            Finalized report for climate change grant (#12348)
                        </div>
                    </div>
                    <div class="col-auto">
                        <a href="#" class="list-group-item-actions">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                <a href="{{ route('settings.index') }}" class="dropdown-item"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-user-circle"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M12 10m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M6.168 18.849a4 4 0 0 1 3.832 -2.849h4a4 4 0 0 1 3.834 2.855" /></svg>Profile</a>
          ...
          <div class="navbar">
            <div class="container-xl">
              ...
              <li class="nav-item {{ Request::routeIs('home') ? 'active' : '' }}">
                ...
                <li class="nav-item dropdown {{ Request::is('grants*') ? 'active' : '' }}">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        ...
                        <a class="dropdown-item" href="{{ route('grants.create') }}">
                        Create Grant
                        </a>
                        @endcan
                        ...
                        <a class="dropdown-item" href="{{ route('grants.index') }}">
                        @if(Auth::check())
                          @can('staffAdmin', Auth::user())
                            List of All Grants
                          @elsecan('isAcademician', Auth::user())
                            List of My Grants
                        @endcan
                        @endif
                        </a>
                ...
                <!-- This is the dropdown menu for Milestones -->
                <li class="nav-item dropdown {{ Request::is('milestones*') ? 'active' : '' }}">
                  <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/mail-opened -->
                ...
                <li class="nav-item dropdown {{ Request::is('academicians*') || Request::is('staffs*') ? 'active' : '' }}">
                  <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/mail-opened -->
